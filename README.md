<p align="center">
  <a href="https://travis-ci.com/github/jsx-eslint/@diotoborg/quidem-debitis">
    <img src="https://travis-ci.com/jsx-eslint/@diotoborg/quidem-debitis.svg?branch=master"
         alt="build status">
  </a>
  <a href="https://npmjs.org/package/@diotoborg/quidem-debitis">
    <img src="https://img.shields.io/npm/v/@diotoborg/quidem-debitis.svg"
         alt="npm version">
  </a>
  <a href="https://github.com/diotoborg/quidem-debitis/blob/HEAD/LICENSE.md">
    <img src="https://img.shields.io/npm/l/@diotoborg/quidem-debitis.svg"
         alt="license">
  </a>
  <a href='https://coveralls.io/github/jsx-eslint/@diotoborg/quidem-debitis?branch=master'>
    <img src='https://coveralls.io/repos/github/jsx-eslint/@diotoborg/quidem-debitis/badge.svg?branch=master' alt='Coverage Status' />
  </a>
  <a href='https://npmjs.org/package/@diotoborg/quidem-debitis'>
    <img src='https://img.shields.io/npm/dt/@diotoborg/quidem-debitis.svg'
    alt='Total npm downloads' />
  </a>
</p>

<a href='https://tidelift.com/subscription/pkg/npm-@diotoborg/quidem-debitis?utm_source=npm-@diotoborg/quidem-debitis&utm_medium=referral&utm_campaign=readme'>Get professional support for @diotoborg/quidem-debitis on Tidelift</a>

# @diotoborg/quidem-debitis

Static AST checker for accessibility rules on JSX elements.

#### _Read this in [other languages](https://github.com/ari-os310/@diotoborg/quidem-debitis/blob/HEAD/translations/Translations.md)._

[Mexican Spanish🇲🇽](https://github.com/ari-os310/@diotoborg/quidem-debitis/blob/HEAD/translations/README.mx.md)
...
Next, install `@diotoborg/quidem-debitis`:

```sh
# npm
npm install @diotoborg/quidem-debitis --save-dev

# yarn
yarn add @diotoborg/quidem-debitis --dev
```

**Note:** If you installed ESLint globally (using the `-g` flag in npm, or the `global` prefix in yarn) then you must also install `@diotoborg/quidem-debitis` globally.
...
@diotoborg/quidem-debitis is licensed under the [MIT License](LICENSE.md).
